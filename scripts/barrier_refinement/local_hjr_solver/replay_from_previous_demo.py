...
def load_result_and_check_visualizations():
    result = LocalUpdateResult.load("data/local_update_results/demo_local_hjr_boundary_decrease_solver_on_quadcopter_vertical_ncbf-20230207_233018.dill")
    ...
    result.plot_value_function_against_truth(
        ...
        verbose=True,
        target_time=-2.5,
        save_path='data/tabulated_value_functions/demo_local_hjr'
    )
