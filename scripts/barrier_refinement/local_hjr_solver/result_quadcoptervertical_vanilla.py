...
def result_vanilla_quadcopter_vertical(verbose: bool = False, save_gif: bool = False, save_result: bool = False):
...
if __name__ == '__main__':
    result_vanilla_quadcopter_vertical(verbose=True, save_gif=False, save_result=False)
