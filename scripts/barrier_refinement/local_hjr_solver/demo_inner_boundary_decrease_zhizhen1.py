...
def demo_local_hjr_inner_boundary_decrease_zhizhen1(verbose: bool = False, save_gif: bool = False, save_result: bool = False):
    ...
    # load into solver
    solver = LocalHjrSolver.as_inner_boundary_decrease(
        hj_setup=hj_setup,
        ...
        if save_gif:
            result.create_gif(
                ...
                save_path=os.path.join(
                    ...
                    f'{generate_unique_filename("demo_local_hjr_inner_boundary_decrease_zhizhen1", "gif")}')
            )
        else:
            result.create_gif(
                reference_slice=ref_index,
...
if __name__ == '__main__':
    demo_local_hjr_inner_boundary_decrease_zhizhen1(verbose=True, save_gif=False, save_result=True)
